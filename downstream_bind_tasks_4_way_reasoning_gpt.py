...
dataloader = MiniImageNetDataLoader(shot_num=3, way_num=4, episode_test_sample_num=1, metatrain_folder="/srv/datasets/miniimagenet/train/", metaval_folder="/srv/datasets/miniimagenet/val/", metatest_folder="/srv/datasets/miniimagenet/test/")
...
for idx in tqdm(range(EPOCHS)):
    ...
    items = ["rock", "leaf", "coat", "jack"]
    induction = "Answer with rock, leaf, coat or jack."
    label     = []
    label_res_1 = ["Answer with rock, leaf, coat or jack."]
