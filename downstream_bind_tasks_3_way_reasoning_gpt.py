...
dataloader = MiniImageNetDataLoader(shot_num=3, way_num=3, episode_test_sample_num=1, metatrain_folder="/srv/datasets/miniimagenet/train/", metaval_folder="/srv/datasets/miniimagenet/val/", metatest_folder="/srv/datasets/miniimagenet/test/")
...
for idx in tqdm(range(EPOCHS)):
    ...
    items = ["rock", "leaf", "coat"]
    induction = "Answer with rock, leaf or coat."
    label     = []
    label_res_1 = ["Answer with rock, leaf or coat."]
